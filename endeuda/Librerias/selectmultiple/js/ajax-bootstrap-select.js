...
!(function ($, window) {
    ...
    $.fn.ajaxSelectPicker.locale['en-US'] = {
         ...
         */
        errorText: 'No se pueden recuperar los resultados',
         ...
         */
        statusInitialized: 'Escriba criterio de búsqueda',
         ...
         * The text used in the status container when the request returns no results.
         */
        statusTooShort: 'Ingrese más caracteres'
    };
